...
work3 / work3.wiki / external repos were **not** benchmarked here — work3 lives on another machine and the constraint is no work3 content in prompt context. This audit benchmarks the local zdots repo; the Rails projections for work3 are in `rails-graphify-strategy.md`.
