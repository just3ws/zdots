...
app / app.wiki / external repos were **not** benchmarked here — app lives on another machine and the constraint is no app content in prompt context. This audit benchmarks the local zdots repo; the Rails projections for app are in `rails-graphify-strategy.md`.
