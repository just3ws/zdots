...
@test "docs: every bin executable is --help-tested or in the known-gaps file" {
  ...
  local -a tested=(
    ...
    zdots zdots-artifact zdots-debrief zdots-snapshot zdots-search
  )
