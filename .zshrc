...
# put removed files in trash (brew install osxutils)
alias rm="trash"
...
# Not the ideal implementation but ...
ssh-add -l &> /dev/null
if [[ "$?" == 1 ]]
then
