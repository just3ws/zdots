...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Phase 1: openobserve-ctl (install/start/stop/restart/status/health/logs) installs pinned sha-verified darwin-arm64 binary; root password in Keychain not plist; binds 127.0.0.1; ZO_TELEMETRY=false; registered as zsvc 'o2'; runs alongside LGTM (no teardown)
