...
2026-08-01 audit: implementation landed — bin/zdots-draft (935e221e3) does semantic multi-video retrieval + article synthesis. Remaining: one verification run capturing AC#2 (quotes from ≥2 videos) + AC#3 (timeline snippets), then close.
<!-- SECTION:NOTES:END -->
