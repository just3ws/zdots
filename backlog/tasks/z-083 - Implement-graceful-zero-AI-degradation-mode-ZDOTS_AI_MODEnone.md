...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 ZDOTS_AI_MODE=none causes ai-query to exit 2 immediately with 'AI unavailable: ZDOTS_AI_MODE=none' — no network attempt
- [ ] #2 ZDOTS_AI_MODE=none causes zdots-ctx hydrate and zdots-ctx capture inference paths to exit cleanly with same message
- [ ] #3 bootstrap probes ZDOTS_AI_ENDPOINT with a 2-second timeout; if unreachable and ZDOTS_AI_MODE is not already set to cloud, prints a prominent warning and exports ZDOTS_AI_MODE=none for the session
