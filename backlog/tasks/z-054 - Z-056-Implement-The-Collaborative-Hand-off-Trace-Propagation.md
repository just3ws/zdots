...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 bin/gemini-invoke (and other agent bridges) accepts and propagates ZDOTS_TRACE_ID.
- [ ] #2 Subagent operations (replacements, shell commands) are tagged with the parent Trace ID in OTel.
- [ ] #3 Grafana Tempo shows a unified trace view combining human shell commands and agent tool calls.
<!-- AC:END -->
