...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 zdots-ctl status uses the CLI interface of child services (e.g. otel-collector status --json) instead of launchctl directly.
- [x] #2 Removing or changing the launchd implementation of a service does not break zdots-ctl.
- [x] #3 zdots-ctl health checks are derived from service-level health subcommands.
<!-- AC:END -->
