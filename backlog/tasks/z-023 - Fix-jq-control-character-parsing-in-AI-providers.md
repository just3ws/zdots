...
Fixed jq control-character parse failures in AI providers by adding defensive tr -d scrubbing before JSON parsing and default value fallbacks (// empty) throughout providers/ai/.
