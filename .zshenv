...
export OPENFAAS_URL='http://raspberrypi.localdev.lan:8080'
export OPENFAAS_PASSWORD='REMOVED'
export OPENFAAS_PREFIX='just3ws'
# cat ~/faas_pass.txt | faas-cli login --password-stdin --tls-no-verify --gateway http://raspberrypi.localdev.lan:8080
