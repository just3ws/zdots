...
| 11 | **LOW** | ZSH_QUALITY | `conf.d/40-completion.zsh:31` | `autoload -Uz "$(basename $fn)"` forks `basename` for each function file. Use Zsh parameter expansion `"${fn:t}"` instead (zero forks). | **FIXED** |
