...
- **Deliberation:** Use the `zsynod` forum for multi-agent consensus, durable handoffs, and AI-governed "ratchet" loops. See [zsynod/LIFECYCLE.md](zsynod/LIFECYCLE.md) and [docs/zsynod-charter.md](docs/zsynod-charter.md).
