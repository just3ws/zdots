...
*   **Colima/Docker Socket**: If Postgres/Redis fail to start but appear registered, verify the Docker socket is present: `ls /Users/mike/.config/colima/default/docker.sock`.
